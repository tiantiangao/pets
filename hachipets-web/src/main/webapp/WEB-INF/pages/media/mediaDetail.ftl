...
<div class="container">
    <div class="pets-movie-detail">
        <div class="pets-movie-return"><a href="<#if canReturnHistory>javascript:if(history.length>1){history.go(-1);}else{window.location.href='/media';}<#else>/media</#if>">&lt;&lt; 返回</a></div>
