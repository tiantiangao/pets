...
import com.gtt.pets.constants.Adwords;
...
public class PetsBaikeDetailAction extends BaseAction {
    ...
    private AdwordsDTO foodAD;
    private AdwordsDTO otherAD;
    ...
    private void initAdwords() {
        foodAD = adwordsService.load(Adwords.AD_BAIKE_FOOD, type.getId());
        otherAD = adwordsService.load(Adwords.AD_BAIKE_OTHER, type.getId());
    }
    ...
    public AdwordsDTO getFoodAD() {
        return foodAD;
    }

    public AdwordsDTO getOtherAD() {
        return otherAD;
    }
}
